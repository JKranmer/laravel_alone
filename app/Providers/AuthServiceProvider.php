...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Gate::define('enable-user',['App\Policies\UserPolicy', 'enable']);
        
        Gate::define('list-userType',['App\Policies\UserTypePolicy', 'list']);
        Gate::define('form-userType',['App\Policies\UserTypePolicy', 'form']);
        Gate::define('save-userType',['App\Policies\UserTypePolicy', 'save']);
        Gate::define('delete-userType',['App\Policies\UserTypePolicy', 'delete']);
        Gate::define('enable-userType',['App\Policies\UserTypePolicy', 'enable']);
        //
    }
}
